 ...
 */
 ...
 function Private_GetInsuranceReservatonByOrgID(payload) {
    ...
    /* 
        * Which insurance object to look into if both owner and renter_owner have insurance_outgoing array of objects.
        * How to filter out invalid, missing, verification need insurances from this object ?
    */
  ...
  exports = Private_GetInsuranceReservatonByOrgID;
  
  // export locally for use in unit test
  if (typeof module !== "undefined") {
    module.exports = { Private_GetInsuranceReservatonByOrgID };
  }
